...
#include <memory>
#include "../3-SignalSlot/subwidget.h"
...
QT_MOC_LITERAL(3, 18, 9) // "SubToMain"

    },
    "SubWidget\0Signal\0\0SubToMain"
};
...
void SubWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SubWidget::Signal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SubWidget::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SubWidget::Signal)) {
                *result = 1;
                return;
            }
...
// SIGNAL 1
void SubWidget::Signal(QString _t1)
{
