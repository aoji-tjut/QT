...
QT_MOC_LITERAL(1, 8, 13), // "Thread1Signal"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "Thread1\0Thread1Signal\0"
};
...
void Thread1::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread1::Thread1Signal)) {
                *result = 0;
                return;
            }
        }
